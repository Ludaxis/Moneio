/**
 * Aged Payables Report API
 *
 * GET /api/reports/aged-payables?workspaceId=xxx&asOfDate=YYYY-MM-DD
 *
 * Returns aging report for accounts payable including:
...
export async function GET(request: Request) {
  try {
    ...
    console.error('Failed to generate aged payables report:', error);
